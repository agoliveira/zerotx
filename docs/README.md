...
- [protocols/crsf-tee.md](protocols/crsf-tee.md): daemon to mwp telemetry tee
- [protocols/vfd.md](protocols/vfd.md): daemon to Pro Micro VFD ASCII protocol (legacy; current VFD lives on Mega per `firmware/io/`)
